...
export const AppProvider = ({ children }) => {
    ...
    const authValue = { user, loading: authLoading, login, logout, likedVideoIds, toggleLike, setLikedVideoIds };
    const searchValue = { query, setQuery, videos, setVideos, nextPageToken, setNextPageToken };
...
export const useSearch = () => {
    ...
    if (context === undefined) throw new Error("useSearch must be used within an AppProvider");
    return context;
};